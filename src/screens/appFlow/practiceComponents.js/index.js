      ...
      <Wrapper isMain style={[{}]}>
        <ScrollViews.KeyboardAvoiding>
          ...
          <Wrapper marginHorizontalZero>
            <TextInputs.Bordered placeholder="Email" iconName="email" />
            <TextInputs.SearchBar placeholder={'Search items...'} />
            <TextInputs.Underlined
              placeholder="Password"
              iconName="lock"
              secureTextEntry
            />
            <TextInputs.Colored placeholder="Email" iconName="email" />
          </Wrapper>
          <Spacer isBasic />
